                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 overflow-hidden">
                    ...
                    <div className="relative">
                      <div className="flex flex-col gap-3 sm:flex-row sm:gap-0">
                        <select
                          ...
                          title={`${formData.countryCode} - ${countryCodes.find(c => c.code === formData.countryCode)?.country || ''}`}
                        >
                  ...
                  <div className="group relative overflow-visible">
                    ...
                    <div className="relative z-10">
                      ...
                      >
                        <option key="apartment" value="apartment" className="py-3 px-4 text-base bg-dark-700 text-white">Luxury Apartment</option>
                        <option key="villa" value="villa" className="py-3 px-4 text-base bg-dark-700 text-white">Premium Villa</option>
                        <option key="penthouse" value="penthouse" className="py-3 px-4 text-base bg-dark-700 text-white">Exclusive Penthouse</option>
                        <option key="townhouse" value="townhouse" className="py-3 px-4 text-base bg-dark-700 text-white">Designer Townhouse</option>
                        <option key="studio" value="studio" className="py-3 px-4 text-base bg-dark-700 text-white">Modern Studio</option>
                        <option key="commercial" value="commercial" className="py-3 px-4 text-base bg-dark-700 text-white">Commercial Property</option>
                        <option key="investment" value="investment" className="py-3 px-4 text-base bg-dark-700 text-white">Investment Opportunity</option>
                      </select>
                      <div className="absolute inset-0 bg-gradient-to-r from-gold-500/5 to-gold-400/5 rounded-lg sm:rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                    </div>
                  </div>
